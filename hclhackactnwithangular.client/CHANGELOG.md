...
- Create Angular project with ng: `ng new hclhackactnwithangular.client --defaults --skip-install --skip-git `.
...
- Create project file (`hclhackactnwithangular.client.esproj`).
